...
export function MarketOpportunitySectionEN() {
  const stats = [
    {
      number: "$7.9T USD",
      description: "Expected global cross-border B2C e-commerce market value for 2030",
      source: "Shopify EY",
    ...
    {
      number: "31.2%",
      description: "Of all online sales globally are cross-border",
      source: "Capital One",
    ...
    {
      number: "~572M",
      description: "Cross-border buyers in the world",
      source: "AMVO Mexico",
    ...
    {
      number: "71.8M",
      description: "Americans will make international purchases in 2024",
      source: "Capital One",
      sourceUrl: "https://capitaloneshopping.com/research/cross-border-online-shopping-statistics/",
    ...
    {
      number: "83%",
      description: "Of the businesses increased their sales in countries with Shopify Managed Markets",
      source: "Capital One",
      sourceUrl: "https://capitaloneshopping.com/research/cross-border-online-shopping-statistics/",
    ...
    {
      number: "31.9%",
      description: "Of buyers in the U.S. have made international purchases from retailers last year",
      source: "Capital One",
      sourceUrl: "https://capitaloneshopping.com/research/cross-border-online-shopping-statistics/",
