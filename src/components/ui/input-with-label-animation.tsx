  ...
  return (
    <div className="group relative w-full">
      ...
      <Input 
        ...
        value={value}
        onChange={onChange}
        className={`h-12 border-gray-200 focus:border-[#131F42] focus:ring-1 focus:ring-[#131F42] transition-colors font-light ${className}`}
      />
    </div>
  )
}
